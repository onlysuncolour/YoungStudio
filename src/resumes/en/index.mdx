...
* Spearheaded development of MOS’s large language model interface, **Mochat**.
  1. Designed the product scheme for large language model applications.
  2. Developed the interface interaction for large language model applications.
  3. Abstracted the page data structure to support large language model and user page interaction.

Tech Stack: React, TypeScript, Low-Code, Docker, Nginx, Webpack, ECharts

#### Internal Developer Platform, DevOps Platform, Management Platform (MDP)
...
Tech Stack: React, Next.js, TypeScript, Docker, Nginx, Webpack, MySQL, Low-Code
