...
I started to work with global colleagues from this project, and make global website for multi-languanges and people with disabilities.  
...
* Intergrated third-party components and done security check under eBay's policy.
...
* Complished many sharing and presentation about developing knowledge includes frontend, git, server side.
...
* Using WebRTC to complish calling function.
